...
public class GlBaseFilter implements GlFilter {
    ...
    public GlBaseFilter(final Resources res, final int vertexShaderSourceResId, final int fragmentShaderSourceResId) {
        this(res.getString(vertexShaderSourceResId), res.getString(fragmentShaderSourceResId));
    }

    public GlBaseFilter(final String vertexShaderSource, final String fragmentShaderSource) {
    ...
    @Override public void draw(final int texName, final int frameBufferName) {
        useProgram();
